...
<script>
        ...
        window.onload = function(){
           ...
           var icons = [];
			...
			icons.push({'iconFilePath':'img/colorp1.png', 'iconValue':'11'});
			icons.push({'iconFilePath':'img/colorp2.png', 'iconValue':'2'});
			icons.push({'iconFilePath':'img/colorp2.png', 'iconValue':'21'});
			icons.push({'iconFilePath':'img/colorp3.png', 'iconValue':'3'});
			icons.push({'iconFilePath':'img/colorp3.png', 'iconValue':'31'});
	...
	// $('#charts').on('hide.bs.modal', function (e) {
				...
				<form action="" role="form">
					<div class="panel panel-primary">
						...
						<hr color="#0033FF" size="3">
							...
							<div class="col-sm-3">
								<label class="radio-inline"><input type="radio" name="layers" ng-click="displayAB()" id="radioAB" />A-B</label>
                            </div>
						</div>
						...
						<div class="panel-body text-center">
							<div class="row">
							 ...
							 <div class="col-md-12" style="margin-top:10px;">
							 		<button style="width:120px;" class="btn btn-primary btn-sm" onclick="showChartsRequest({{queryid_a}},{{queryid_b}});" id="showchart">Show Chart</button>
							...
							<div class="form-group">
								...
								<div class="col-sm-3"
									...
									<button class="btn btn-primary btn-md" style="font-size: 12px"
										 ng-click="insertdata_a('a');" id="EvaluateA">View</button>
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3"
									style="text-align: left; padding-top: 5px; padding-right: 5px">
									<button class="btn btn-primary btn-md" style="font-size: 12px"
										ng-click="insertdata_b('b');" id="EvaluateB">View</button>
				...
				<div id="map-wrapper"
					...
					<div id="colour-palette">
						<div id="button-wrapper">
							<div class="btnStyle span3" width="310px">
								<table width="220px">
									<tr>
										<td width="30px"><input size="5" ng-model="colormin" value=0
										...
										<td width="30px"><input size="255" ng-model="colormax"
											value="40"
											style="background-color: #222; border: 1px solid #888; color: white; margin: 0px; padding: 0px; width: 30px"></td>
									</tr>
									<tr>
					...
					<div id="queryd">
						<div id="query-wrapper" >
							<div class="btnStyle span3" style="background-color: #FFFFFF; color: black; font-size: 12px;width:300px;height:60px;padding:5px">
								<span>Query : {{query_display}}</span></br>
								<span>Data Range : {{minrange}}-{{maxrange}} {{units}}</span>
							</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true" onclick="modelclosed();">×</button>
				...
				<div class="modal-footer">
					<div class="col-md-12">
						<button class="btn" data-dismiss="modal" aria-hidden="true" onclick="modelclosed();">Cancel</button>
					</div>
				</div>
			</div>
		</div>
