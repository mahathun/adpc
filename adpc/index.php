	...
	<div class="container">
  	...
  	<tr>
		...
		?>
  		...
  		<td><a href="add_observed_data.php?station_name=<?php echo $GetStationRow['name'];?>&station_id=<?php echo $GetStationRow['id'];?>" class="btn btn-primary btn-xs">Add</button></td>
  	</tr>
  	<?php 
  			}
  		}
