						...
						<div class="panel-body text-center">
							<div class="row">
							 ...
							 <div class="col-md-12" style="margin-top:10px;">
							 		<button style="width:120px;" class="btn btn-primary btn-sm" onclick="getQueryId(1);getQueryId(2);showChartsRequest(qi1,qi2);" id="showchart">Show Chart</button>
							...
							<div class="form-group">
								...
								<div class="col-sm-3"
									...
									<button class="btn btn-primary btn-md" style="font-size: 12px"
										 onclick="getQueryId(1);" ng-click="insertdata_a('a');getQueryId(1);" id="EvaluateA">Evaluate</button>
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3"
									style="text-align: left; padding-top: 5px; padding-right: 5px">
									<button class="btn btn-primary btn-md" style="font-size: 12px"
										 onclick="getQueryId(2);" ng-click="insertdata_b('b');getQueryId(2);"  id="EvaluateB">Evaluate</button>
