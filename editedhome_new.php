            ...
            <div class="col-md-2">
                ...
                <form action="" role="form">
					<div class="panel panel-success">
                        ...
                        <p class="text-center">
                            <button style="width:100px; border-radius:10px;" class="btn btn-primary btn-md">Show Chart</button>                      		 <button style="width:140px; border-radius:10px;" class="btn btn-primary btn-md">Map Data (CSV)</button>
